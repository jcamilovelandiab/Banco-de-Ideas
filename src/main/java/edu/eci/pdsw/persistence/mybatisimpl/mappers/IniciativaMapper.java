...
public interface  IniciativaMapper {
    ...
    public void agregarComentario(@Param("usr")Usuario usr, @Param("ini")Iniciativa ini,
    ...
    public void modificarEstado(@Param("idIni")long ini, @Param("estado") Estado estado);
